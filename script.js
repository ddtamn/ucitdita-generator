...
guestName.addEventListener("input", (e) => {
  invitationURI.value =
    "https://dinvite.online/ucitdita?to=" + convertToSlug(e.target.value);
  ...
  shareButton.href = `https://api.whatsapp.com/send/?text=https://dinvite.online/ucitdita?to=${convertToSlug(
    e.target.value
  )}`;
});
